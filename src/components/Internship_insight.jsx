...
export default function Internships() {
  ...
  const selectedDatesFromPicker = datepicker.getSelectedDates();

  setSelectedDates(selectedDatesFromPicker);
  console.log('Selected Dates:', selectedDatesFromPicker);
  };
  ...
  return (
    <div className='middiv--rightdiv'>
      ...
      <div className='middiv--headerdiv'>
        ...
        <button className='button3' onClick={handleSelectDates}>
          <img src={calendar} alt="calendar" />Select dates
        </button>
